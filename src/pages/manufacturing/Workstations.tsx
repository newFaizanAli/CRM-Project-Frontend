...
import WorkstationForm from "../../components/form/manufacturings/WorkstationForm";
import useWorkstationStore from "../../store/manufacturing/workstations";

const columnHelper = createColumnHelper<Workstation>();

const columns: ColumnDef<Workstation, any>[] = [
  ...
  // costPerHour
  columnHelper.accessor("capacityPerHour", {
    header: "Capacity Per/h",
    cell: (info) => info.getValue(),
  }),
...
const WorkstationsPage = () => {
  const { workstations, deleteWorkstation, fetchWorkstations, isFetched } =
    useWorkstationStore();
