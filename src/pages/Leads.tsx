...
const columnHelper = createColumnHelper<LeadInput>();

const columns: ColumnDef<LeadInput, any>[] = [
...
const Leads = () => {
  const { leads, fetchLeads, deleteLead, isFetched } = useLeadsStore();

  const [isModalOpen, setIsModalOpen] = useState(false);
  const [selectedLead, setSelectedLead] = useState<LeadInput | undefined>();
  ...
  const handleEdit = (lead: LeadInput) => {
